        ...
        <header className="navbar navbar-expand navbar-dark flex-column flex-md-row bd-navbar bg-dark">
            ...
            <div className="navbar-nav-scroll">
                <ul className="navbar-nav bd-navbar-nav flex-row">
                    ...
                    <li className="nav-item">
                        <a className="nav-link " href="/docs/4.3/getting-started/introduction/" onclick="ga('send', 'event', 'Navbar', 'Community links', 'Docs');">Documentation</a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link " href="/docs/4.3/examples/" onclick="ga('send', 'event', 'Navbar', 'Community links', 'Examples');">Examples</a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link" href="https://themes.getbootstrap.com/" onclick="ga('send', 'event', 'Navbar', 'Community links', 'Themes');" target="_blank" rel="noopener">Themes</a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link" href="https://expo.getbootstrap.com/" onclick="ga('send', 'event', 'Navbar', 'Community links', 'Expo');" target="_blank" rel="noopener">Expo</a>
                    </li>
                    <li className="nav-item">
            ...
            {/* <ul className="navbar-nav flex-row ml-md-auto d-none d-md-flex">
                <li className="nav-item dropdown">
                    ...
                    <div className="dropdown-menu dropdown-menu-right" aria-labelledby="bd-versions">
                        <a className="dropdown-item active" href="/docs/4.3/">Latest (4.3.x)</a>
                        <a className="dropdown-item" href="https://getbootstrap.com/docs/4.2/">v4.2.1</a>
                        <a className="dropdown-item" href="https://getbootstrap.com/docs/4.0/">v4.0.0</a>
                        <div className="dropdown-divider"></div>
                        <a className="dropdown-item" href="https://v4-alpha.getbootstrap.com/">v4 Alpha 6</a>
                        <a className="dropdown-item" href="https://getbootstrap.com/docs/3.4/">v3.4.1</a>
